...
<body>
    <header>
        <nav>
            ...
            <main class="main">
                <section>
                    <h3>"Welcome to your Mentors World"</h3>
                    <div class="wrapper">
                      
                      <ul class="dynamic-txts">
                        <li><span>JEE-MAINS</span></li>
                        <li><span>NEET-UGC</span></li>
                        <li><span>JEE-ADVANCED</span></li>
                        <li><span>UPSC</span></li>
                        <li><span>NTA</span></li>
                        <li><span>JAM</span></li>
                      </ul>
                    </div>
            ...
            <div class="text1"><h5 class="animate__animated animate__flipInX animate__infinite	infinite ">Academic Session</h5></div>
    </header>
    ...
    <section>
      <div class="text12"><h5 class="animate__animated animate__flipInX animate__infinite	infinite ">Our Team</h5></div>
      ...
      <div class="abhishek">
        ...
        <main class="grid">
          ...
          <article>
            ...
            <div class="text">
              <div>
                <img  class="avtar"src="img\bbb.jpeg">
                  </div>
                    <h3>SUNIL</h3>
                      <p class="pc">"Overall a very informative content which delivered in Brain Mentors. Course 
          ...
          <article>
            ...
            <div class="text">
              <div>
                <img  class="avtar"src="img\atul.jpg">
                  </div>
                      <h3>ATUL</h3>
                      
                        
                        <p class="pc">"It was excellent journey with Brain Mentors . Among all batches also got come new daily using tricks as well as understand all lecture 
          ...
          <article>
            ...
            <div class="text">
              <div>
                <img  class="avtar"src="img\ankit.jpg">
                  </div>
                    <h3>ANKIT</h3>
          ...
          <article>
            ...
            <div class="text">
              <div>
                <img  class="avtar"src="img\abhishek.jpg">
                  </div>
                    <h3>ABHISHEK</h3>
                      <p class="pc">"Overall a very informative content which delivered in Brain Mentors. Course 
                        content got well covered and also demonstrated the concept very well. Thanks for such an informative and concept-clearing 
        ...
        <div class="content">
          <div class="left box">
            <div class="upper">
              ...
              <p>Brain mentors is a place where you can shap your mind with the help of our mentors</p>
            </div>
            <div class="lower">
          ...
          <div class="middle box">
            ...
            <div><a href="#">Our Exclusive staff</a></div>
            <div><a href="#">Signup</a></div>
            <div><a href="#">Explore our another branches</a></div>
          </div>
          <div class="right box">
            ...
            <form action="#">
              ...
              <div class="media-icons">
                <a href="https://www.facebook.com/Chemestry-Pathsala-111913571172406"><i class="fab fa-facebook-f"></i></a>
                <a href="https://www.instagram.com/ysabhishekmishra/?utm_medium=copy_link"><i class="fab fa-instagram"></i></a>
                <a href="https://twitter.com/Ysabhishekmish2"><i class="fab fa-twitter"></i></a>
